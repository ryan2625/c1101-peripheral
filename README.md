...
> Note: Using ESP-IDF directly gives us more control over writing firmware, but it requires more manual setup in the process and the complexity increases quickly. If you are looking for an easier solution for writing firmware, use Arduino. 
